...
from nets.nets.mobilenetv3 import mobilenet_v31
...
class PSPNet(nn.Module):
    def __init__(self, num_classes, downsample_factor, backbone="resnet50", pretrained=False, aux_branch=True):
        ...
        if backbone == "resnet50":
            ...
            aux_channel = 96   # 根据 FasterNet 的实际通道数调整
            out_channel = 192  # 根据 FasterNet 的实际通道数调整
