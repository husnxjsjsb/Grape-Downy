...
from leison.UNet.nets.unet_mobilenetv2 import Unet
# from nets.unet_mobilenetv3_1 import Unet
from nets.unet_training import get_lr_scheduler, set_optimizer_lr, weights_init
from utils.callbacks import EvalCallback, LossHistory
from utils.dataloader import UnetDataset, unet_dataset_collate
from utils.utils import (cvtColor, download_weights, preprocess_input, resize_image, seed_everything, show_config,
                         worker_init_fn)
...
if __name__ == "__main__":
    ...
    if Cuda:
        if distributed:
            model_    = model_train.cuda(local_rank)
