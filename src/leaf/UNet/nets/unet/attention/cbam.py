...
class DSAM(nn.Module):
    def __init__(self, in_channels, kernel_size=3):
        ...
        self.conv = nn.Conv2d(in_channels, in_channels, kernel_size=self.kernel_size, stride=1, padding=self.kernel_size // 2, groups=in_channels, bias=False)
...
class MBConvBlock(nn.Module):
    """MBConvBlock with CBAM attention mechanism."""
    def __init__(self, block_args, global_params, image_size=None):
        super().__init__()
        self._block_args = block_args
        self._bn_mom = 1 - global_params.batch_norm_momentum
        self._bn_eps = global_params.batch_norm_epsilon
        self.has_se = False  # Replace SE with CBAM
        ...
        self._depthwise_conv = Conv2d(
            in_channels=oup, out_channels=oup, groups=oup,  # depthwise
        ...
        # CBAM Attention
        self.cbam = CBAMLayer(channel=oup)  # Use CBAM instead of SE
